            ...
            <div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="col s3 m3">
                    ...
                    </div>
                        {
                            Object.keys(StatusCount).map((slice)=>{
                                return(
                                    <div id={slice} className="col s1 m1" >
                    ...
                    <div class="row">
                        ...
                        <div class="step" style={{paddingTop:`15px`}}>
                                <div>
                                    ...
                                    <div class="fl_line"></div>
                                </div>
                                <div>
                                    <div class="title" style={{marginBottom:`80px`}}> </div>
                                    <div class="body" style={{border:`none`}}></div>
                                </div>
                                
                            </div>
                            {
                              stepperData.map((slice)=>{
                            ...
                            <div class="step" style={{marginBottom: `15px`}}>
                                <div>
                                    <div class="icon_circle">
